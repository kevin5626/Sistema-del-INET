<?php
    ...
    class CursoDAL {
        ...
        public function insertCurso($curso) {
            ...
            $consulta = (sprintf("INSERT INTO cursos (anio, division, comision, especialidad, turno, ciclo) VALUES('%s', '%s', '%s', '%s', '%s', '%s');",
            $curso -> getAnio(), $curso -> getDivision(), $curso -> getComision(), $curso -> getEspecialidad(), $curso -> getTurno(), $curso -> getCiclo()));
        ...
        public function getCursos(): array {
            ...
            while($registro = mysqli_fetch_array($resultado)) {
                $curso = new Curso ($registro["Id_Curso"], $registro["anio"], $registro["division"], $registro["comision"], $registro["especialidad"], $registro["turno"], $registro["ciclo"]);
