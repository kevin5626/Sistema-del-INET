<?php
    ...
    class TelefonoDAL {
        ...
        public function insertTelefono($telefono) {
            ...
            $consulta = (sprintf("INSERT INTO telefonos (Id_Telefono, tipo_telefono, codigo_area, numero, Id_Tutor) VALUES('%s', '%s', '%s', '%s', '%s');",
            $telefono -> getIdTelefono(), $telefono -> getTipoTelefono(), $telefono -> getCodigoArea(), $telefono -> getNumero(), $telefono -> getIdTutor1()));
